...
- **Usage in this project**: Identifies vulnerabilities in project dependencies (`uv.lock`, etc.).
...
- **Dependency issues**: Update the vulnerable package to a fixed version using `uv add <package>@latest` or `uv lock --upgrade-package <package>`.
