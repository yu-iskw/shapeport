...
If `trunk check` fails due to environment issues, ensure that the required runtimes (e.g., Python) are installed and accessible as defined in `.trunk/trunk.yaml`.
